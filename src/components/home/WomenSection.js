...
const HomeWomenSection = ({ product }) => {
    ...
    return (
        <Card className='mx-4'   >
            <NavLink to={`/products/women/${product.category.name}/${product.category.parentCategory.name}/${product._id}`} >
...
export default HomeWomenSection